        ...
        <div className="flex justify-center mt-16 ">
            ...
            <div className="flex flex-col w-[75%] min-h-[90vh]">
                ...
                <div className="w-[100%] flex justify-around items-center h-[60%]">
                    <div className="flex xl:w-[50%] md:w-[80%] max-md:w-[100%] justify-around">
            ...
            <div className="absolute w-[100%] bg-gradient-to-r from-black via-[#1b242f] to-black h-[150px] bottom-0 flex justify-center items-center shadow-lg rounded-t-md flex-col max-xl:h-[170px]">
